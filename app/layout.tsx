...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = "WHT Recovery Control Workspace";
  const description = "An evidence-first workflow for finding and resolving Nigerian withholding-tax receivables.";
  ...
  return {
    ...
    openGraph: {
      ...
      description,
      type: "website",
      images: [{ url: `${origin}/og.png`, width: 1731, height: 909, alt: "WHT Recovery evidence-first control workspace" }],
    },
    twitter: {
