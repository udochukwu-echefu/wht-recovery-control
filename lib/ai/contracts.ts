import type { LedgerTargetField } from "../ledger-fields.ts";
export {
  ledgerTargetFields,
  type LedgerTargetField,
} from "../ledger-fields.ts";
...
export type SourceReference = {
  type: "case_field" | "document" | "audit_event" | "aggregate" | "rule";
  id: string;
  label: string;
};
...
export type ReceiptExtractionOutput = {
...
export type RecoveryPlanOutput = {
  ...
  evidenceChecklist: Array<{
    ...
    responsibleParty: "deducting_customer" | "internal" | "authority";
  }>;
...
export type CommunicationDraftOutput = {
  draftType: string;
  subject: string;
  body: string;
  sourceLabels: string[];
...
export type EvidenceSummaryOutput = {
...
export type PortfolioBriefingOutput = {
  narrative: string;
